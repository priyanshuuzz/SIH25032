...
const DashboardRoute = () => {
      ...
      <>
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Access Your Seller Dashboard</h2>
            <p className="text-gray-600 mb-8">Sign in to manage your products, track orders, and grow your business on the Jharkhand Tourism Platform.</p>
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full border-2 border-emerald-600 text-emerald-600 hover:bg-emerald-50 py-3 px-6 rounded-lg font-semibold transition-colors"
              >
  ...
  if (userRole === 'gov_admin') {
    ...
    // Regular users get redirected to seller dashboard signup
    return (
      <>
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-8">Join our marketplace as a local artisan or homestay owner to start selling your products and services to tourists.</p>
            <div className="space-y-4">
              <button
                onClick={() => {
                  setAuthMode('signup');
